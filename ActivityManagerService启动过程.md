# 一、概述
讲述system_server进程中AMS服务的启动过程，以startBootstrapServices()方法为起点，紧跟着startCoreServices(), startOtherServices()共3个方法。
...
1. setSystemProcess：注册AMS、meminfo、cpuinfo等服务到ServiceManager；
1. installSystemProviderss，加载SettingsProvider；
1. 再调用一系列服务的systemReady()方法；
